        ...
        <IonCardContent>
          <IonText>
            ...
            <IonIcon
              ...
              icon={closeCircle}
            />{" "}
            representa um nível de dificuldade. Quanto maior sua dificuldade em
            uma matéria, mais horas serão estudadas.
          </IonText>
          ...
          <IonText>
            ...
            />{" "}
            representa uma hora a ser estudada por semana. Marque todas antes de
            recomeçar o ciclo e depois vá desmarcando para o novo ciclo.
          </IonText>
        </IonCardContent>
      </IonCard>
